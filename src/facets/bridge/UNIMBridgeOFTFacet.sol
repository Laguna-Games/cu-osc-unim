...
import {ERC20LZReceiverFacet} from "../../../lib/cu-osc-layerzero/src/ERC20LZReceiverFacet.sol";
...
contract UNIMBridgeOFTFacet is ERC20LZReceiverFacet {
    ...
    function initLZOFTV2(
        ...
        if (_sharedDecimals > _decimals) {
            revert LibLZBridge.LZBridgeInvalidSharedDecimals(
                _sharedDecimals,
                _decimals
            );
        }
    ...
    function _creditTo(
        ...
        LibERC20.mint(_toAddress, _amount);
        return _amount;
    }
    ...
    function _debitFrom(
        ...
        revert LibLZBridge.LZBridgeDebitDisabled(
            _from,
            _dstChainId,
            _toAddress,
            _amount
